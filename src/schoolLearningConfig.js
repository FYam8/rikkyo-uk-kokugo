export const LEARNING_PATH_CONFIG=Object.freeze({
  ...
  oldFit:{},
  oldTieBreak:[],
  route:{recentCheck1:null,recentCheck2:null,loadCheck:null,finalExamKey:null},
  ...
  labels:{
    ...
    bridgeTitle:'',recent1Title:'',recent1Why:'',oldTitle:'',oldWhy:'',
    recent2Title:'',recent2Why:'',loadTitle:'',loadWhy:'',finalTitle:'',finalWhy:'',
    completeTitle:'FY25 A日程の診断完了',
    completeWhy:'現在、採点Authorityを二重検証済みの過去問はFY25 A日程です。弱点補強を続けながら、他年度は検証完了後に追加されます。'
  }
});
